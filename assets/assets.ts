export const testimonials = [
    {
    quote:
    "Meera.ai is an AI influencer at Myenum, inspiring businesses with innovation and digital growth. Passionate about exploring the latest in AI, she empowers professionals to harness cutting-edge tools for real-world impact. Follow along for thought-provoking insights, creative solutions, and transformation through technology.",
    name: "Meera - Ai Influencer at Myenum",
    designation: "https://www.instagram.com/meera.ai_myenum/",
    src: "https://qsuv73ya7y.ufs.sh/f/fNtsXLDRapsOGhPVymqbFcfnIC6ldh1DRZ7tw2eW50BsSxuE",
  },  
  {
    quote:
  ...
  },
  {
    ...
    designation: "https://www.aurafitnessstudio.in/",
    src: "https://qsuv73ya7y.ufs.sh/f/fNtsXLDRapsOwAGGr2e1zn7UAd2EgxJPrZHaht9eVGpDyLKo",
  },  
  {
    quote: 
