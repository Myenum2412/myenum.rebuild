...
const FEATURES = [
  {
    ...
    description: "Custom-built websites and web apps tailored to your brand.",
  },
  {
    id: "agile",
    label: "Agile Process",
    ...
    description: "Iterative sprints that ship features fast and reliably.",
  },
  {
    id: "global",
    ...
    description: "Distributed teams delivering world-class software 24/7.",
  },
  {
    id: "qa",
    ...
    description: "Rigorous testing pipelines that catch bugs before users do.",
  },
  {
    id: "cloud",
    ...
    description: "Scalable cloud architecture built for peak performance.",
  },
  {
    id: "mobile",
    label: "Mobile Apps",
    ...
    description: "Native and cross-platform apps with pixel-perfect UI.",
  },
  {
    id: "analytics",
    ...
    description: "Data-driven dashboards that turn metrics into decisions.",
  },
  {
    id: "security",
    label: "Cybersecurity",
    ...
    description: "Enterprise-grade security woven into every layer of code.",
  },
  {
    id: "ai",
    label: "AI & Automation",
    ...
    description: "Intelligent automation that eliminates manual workflows.",
  },
  {
    id: "team",
    ...
    description: "Embedded engineers who become an extension of your team.",
  },
];
