...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      "Full-featured SaaS platforms with seamless checkout and inventory management.",
    image:
  ...
  },
  {
    ...
    description:
      "Full-featured ERP platforms with seamless checkout and inventory management.",
    image:
      "https://plus.unsplash.com/premium_photo-1720287601300-cf423c3d6760?fm=jpg&q=60&w=3000&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ZXJwJTIwc29mdHdhcmV8ZW58MHx8MHx8fDA%3D",
  }
];
...
export function VerticalTabs() {
  ...
  return (
    <section className="w-full bg-background  max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center order-1 pt-4">
            <div className="space-y-1 mb-12">
              <h2 className="tracking-tight text-3xl font-medium md:text-4xl lg:text-5xl text-foreground whitespace-nowrap">
                Services We Offer 🚀
              </h2>
