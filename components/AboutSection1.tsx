  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        <div className="  text-sm font-semibold uppercase mb-6 flex items-center justify-center gap-2">
          About Us
        </div>
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold  mb-6">
          ...
          >
            {
              "We Build Software That Drives Growth and Transforms Businesses"
            }
          </VerticalCutReveal>
        </h2>
        ...
        <TimelineContent
          ...
          timelineRef={heroRef}
          className="text-neutral-200 text-center sm:text-lg text-sm mb-8 leading-relaxed"
        >
          We are a full-service software development agency crafting scalable
          web apps, mobile solutions, and cloud-native platforms. Our engineers
          turn bold ideas into production-ready products — on time, every time.
        </TimelineContent>
        ...
        <TimelineContent
          ...
          customVariants={revealVariants3}
          timelineRef={heroRef}
          className="bg-primary hover:bg-primary/80 border-primary/80 border flex w-fit mx-auto gap-2 hover:gap-4 transition-all duration-300 ease-in-out text-white px-5 py-3 rounded-full cursor-pointer"
        >
          <Link href={'/product'} className="flex items-center">See Our Work <ArrowRight className="" /></Link>
        </TimelineContent>
      </div>
      <div className="max-w-6xl mx-auto grid grid-cols-4 gap-4 pt-20 lg:h-[26rem] md:h-[22rem] sm:h-[16rem] h-[14rem]">
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0"
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0"
            alt="Code on screen"
            width={128}
            height={160}
            className="object-cover w-full h-full -rotate-6"
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1573164713988-8665fc963095?q=80&w=735&auto=format&fit=crop&ixlib=rb-4.1.0"
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0"
